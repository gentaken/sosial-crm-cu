...
<main class="main-content p-3 p-md-4">
    ...
    <!-- 2. DASHBOARD RAPOR & REKOMENDASI KEUANGAN (EXECUTIVE SUMMARY) -->
    <div class="card shadow-sm border-0 mb-4 border-top border-4 border-primary">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-light text-dark border">Auto-Generated by System</span>
        </div>
        <div class="card-body bg-light">
            <div class="row g-4">
                <!-- Kolom 1: Aset vs Hutang (Visual) -->
                <div class="col-md-4">
                    <div class="p-3 bg-white border rounded h-100 shadow-sm">
                        <span class="d-block small fw-bold text-muted mb-2 text-uppercase">Posisi Net Worth (Core + Lokal)</span>
                        <div class="mb-2">
                        ...
                        <div class="pt-2 border-top">
                            <span class="small text-muted d-block">Kekayaan Bersih Konsolidasi:</span>
                ...
                <!-- Kolom 2: Rasio Keuangan -->
                <div class="col-md-4">
                    <div class="p-3 bg-white border rounded h-100 shadow-sm">
                        <span class="d-block small fw-bold text-muted mb-3 text-uppercase">Indikator Rasio Kelayakan</span>
                        ...
                        <div>
                            <span class="d-block small text-dark mb-1">Repayment Capacity (RPC)</span>
                            <div class="d-flex align-items-center">
                                <span class="fs-6 fw-bold text-<?= $rapor['rpc_color'] ?> me-2">
                                    <?= $rapor['surplus_defisit'] >= 0 ? '+' : '' ?>Rp <?= number_format($rapor['surplus_defisit'],0,',','.') ?> /bln
                                </span>
                            </div>
                            <span class="small text-muted"><i class="bi bi-info-circle me-1"></i><?= $rapor['rpc_status'] ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="p-3 bg-white border rounded h-100 shadow-sm d-flex flex-column justify-content-center">
                        <span class="d-block small fw-bold text-muted mb-3 text-uppercase text-center">Rekomendasi Profil Anggota</span>
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <!-- ========================================================= -->
                <!-- TAB 8: ARSIP DIGITAL (DOCUMENT MANAGEMENT SYSTEM) -->
                <!-- ========================================================= -->
...
<!-- Modal Tambah Dokumen DMS (TAB 8) -->
